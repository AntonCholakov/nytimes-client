        ...
        return (
            <div className={styles.ArticleDetailsWrapper}>
                ...
                <h1 className={styles.Title}>
                    <a href={this.props.selectedArticle.url}
                       target="_blank" rel="noopener noreferrer">{this.props.selectedArticle.title}</a>
                </h1>
                ...
                <div className="row">
                    <div className="col-md-6">
                        <div className={styles.MainImageHolder}>
                            <figure>
                                <img src={this.props.selectedArticle.media[0]['media-metadata'][2].url}
                                     alt={this.props.selectedArticle.media[0].caption}/>
                                <figcaption>{this.props.selectedArticle.media[0].caption}</figcaption>
                            </figure>
                        </div>
                    </div>
                    <div className="col-md-6">
                        <div className={styles.ByLine}>{this.props.selectedArticle.byline}</div>
                        <div className={styles.PublishedDate}>
                            <time>{this.props.selectedArticle.published_date}</time>
                        </div>

                        <p className={styles.Content}>{this.props.selectedArticle.abstract}</p>
                    </div>
                </div>
            </div>
        )
